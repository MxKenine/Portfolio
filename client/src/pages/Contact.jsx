...
export default function Contact() {
    ...
    return (
        <section data-theme="light" className="bg-white py-20 px-6 md:px-12">
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
                ...
                <div>
                    ...
                    <p className="mt-6 text-gray-600 leading-relaxed max-w-sm">
                        ...
                        et du conseil en architecture d'entreprise. Si vous avez un
                        projet qui nécessite précision et scalabilité, discutons-en.
                    </p>
